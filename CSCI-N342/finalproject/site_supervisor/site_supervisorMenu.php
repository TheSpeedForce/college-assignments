...
function PrintTable(){
    # Make table header
    print '<table  name = "dataTable" id="dataTable" class="display" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th>Last Name</th>
            <th>First Name</th>
    ...
    <tbody> <tr><td>Last1</td><td>First1</td><td>Middle1</td><td>Usernam1e</td><td>Email1</td></tr>';
...
<header class="rvt-header" role="banner">
    ...
    <div class="rvt-header__controls">
        ...
        <nav class="rvt-header__main-nav" role="navigation">
            <ul>
                <li>
                    <a href="site_supervisorMenu.php" aria-current = "page">Dashboard</a>
                </li>
                <!-- First Navigation !-->
                <li>
                    <a href="reviewApp.php">Review Applications</a>
                </li>   
