<?php
	...
	$code = $_REQUEST['code'];
	$query = 'SELECT loginInfoId FROM passwordCodes WHERE code = ?';
	$array = array($code);
	$rowData = fetchArray($con, $query, $array);
	if ($rowData != NULL){
		$loginInfoId = $rowData[0]["loginInfoId"];
		$_SESSION['loginInfoId'] = $loginInfoId;
		header("Location: passphraseResetFinal.php");
			

	}
	else {
		$cmessage = "Invalid code, try again";
	...
	<body>
		...
		<div class="rvt-box__body">
				...
				<div class="rvt-box__row rvt-button-group">
					<a class="rvt-button rvt-button--secondary rvt-button--full-width" href = "../index.php">Homepage</a>
				</div>
